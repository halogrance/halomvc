...
<%@ include file="include/header.jsp"%>
 <div class="main container">
            <div class="sub">
                <a class="sub-home" href="">首页</a> >
                <span class="sub-job">求职</span>
            </div>
            <div class="row">
            <div class="link-partner  col-md-4">
                <h1>合作企业</h1>
                <ul>
                    <li><img src="../images/dot-white.png">阿里巴巴</li>
                    <li><img src="../images/dot-white.png">腾讯视频</li>
                    <li><img src="../images/dot-orange.png">土豆网</li>
                    <li><img src="../images/dot-white.png">北京葡萄藤</li>
                    <li><img src="../images/dot-white.png">凤凰卫视</li>
                    <li><img src="../images/dot-white.png">乐视网</li>
                    <li><img src="../images/dot-white.png">全球攻略</li>
                    <li><img src="../images/dot-white.png">IT之家</li>
                    <li><img src="../images/dot-white.png">中关村在线</li>
                    <li><img src="../images/dot-white.png">京东商城</li>
                    <li><img src="../images/dot-white.png">淘宝网</li>
                    <li class="link-end"><img src="../images/dot-white.png">世界之窗</li>
                </ul>
            </div>
            <div class="link-content col-md-8">
                <div class="l-c-top">
                    <div class="l-c-top-img"><span><img src="../images/tudou.jpg"></span></div>
