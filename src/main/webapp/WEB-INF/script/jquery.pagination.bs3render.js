/*
* @Author: Black Lotus
* @Date:   2014-10-09 23:49:03
* @Last Modified by:   Black Lotus
* @Last Modified time: 2014-10-10 00:51:40
*/

!function($){

	$.PaginationRenderers.bs3Renderer = function(maxentries, opts) {
		this.maxentries = maxentries;
		this.opts = opts;
		this.pc = new $.PaginationCalculator(maxentries, opts);
	};
	$.extend($.PaginationRenderers.bs3Renderer.prototype, {
		/**
		...
		createLink:function(page_id, current_page, appendopts){
			...
			if(page_id == current_page){
				...
				a.href=this.opts.link_to.replace(/__id__/,page_id);
			}
			$(a).data('page_id', page_id);
			return lnk;
		},
